<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminMessageBox.aspx.cs" Inherits="WebApplication8.AdminMessageBox" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                     ...
                     <li>
                        <a href="AdminNewMessage.aspx"><i class="fa fa-bar-chart-o"></i>New Message</a>
                    </li>

                   <li>
                        <a href="AdminMessageBox.aspx"><i class="fa fa-qrcode "></i>Inbox</a>
                    </li>
                   

                    <li>
                        <a href="AdminSent.aspx"><i class="fa fa-bar-chart-o"></i>Sent</a>
                    </li>
  ...
  <div id="page-wrapper" >
    ...
    <td><asp:Label ID="Label1" runat="server" Text="Date :" ForeColor="Black" Font-Bold="true"></asp:Label>  <%# Eval("Date")%>
             ...
             <br />
       <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("Email","~/AdminInboxDel.aspx?Email={0}") %>'>Delete</asp:HyperLink>  &nbsp;&nbsp;
