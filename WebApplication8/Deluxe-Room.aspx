<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Deluxe-Room.aspx.cs" Inherits="WebApplication8.WebForm5" %>
	...
	<div class="details">
		<div class="container">
			...
			<div class="col-md-5 details-right">
                <span><strong> <asp:Label ID="Label20" runat="server" Font-Size="XX-Large" Font-Bold="true" ForeColor="Purple" Text="DELUXE ROOM"/></strong></span><br />
				<span><strong><asp:Label ID="Label21" runat="server" Font-Size="Medium" ForeColor="Black" /></strong> </span><ul>				                                                
				<li> <asp:Label ID="Label19" runat="server" Font-Size="Medium" ForeColor="Black" Text="Number of rooms: 128"/></li>
				<li> <asp:Label ID="Label18" runat="server" Font-Size="Medium"  ForeColor="Black" Text="Location: Ground Floor/ First Floor"/></li>
				<li> <asp:Label ID="Label17" runat="server" Font-Size="Medium"  ForeColor="Black"  Text="Size: 310 square feet (28.8 square metres)"/></li> </ul>
				<p>  <asp:Label ID="Label16" runat="server" Font-Size="Medium"  ForeColor="Black" Text="Our luxury rooms have much larger balconies and seating areas. The bathroom contains a bathtub with overhead rain shower."/></p>
			  </div>
				<div class="clearfix"> </div>
    ...
    <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator8" controltovalidate="txtngt" Font-Size="Small"  errormessage="Please enter No nights!"  ForeColor="Red"/>
          ...
          <asp:Label ID="Label12" runat="server" Text="TRANSPORT" Font-Size="Small" ForeColor="Gray" Font-Bold="true"></asp:Label>
                ...
                <asp:DropDownList ID="transport" runat="server" >
                       ...
                       <br />  
                        <asp:Button ID="Button1" runat="server" Text="Check Total" OnClick="Btncheck_Click" />
