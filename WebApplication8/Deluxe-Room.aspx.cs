...
namespace WebApplication8
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        private void LoadString()
        {
            ...
            rm = new ResourceManager("WebApplication8.App_GlobalResources.Deluxe-Room", Assembly.GetExecutingAssembly());
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Session["mail"] != null)
            {
                ...
                bkns.Norooms1 = Convert.ToInt32(txtNoRooms.Text);
                bkns.RoomType = "Duluxe-Room";
                bkns.Name = "".ToString();
                bkns.Surname = "".ToString();
                bkns.Email = TxtEmail.Text;
                bkns.Phone = Request["TxtPhone"].ToString();
                bkns.Total = ((250 * bkns.Mem * bkns.Norooms1) + (10 * bkns.Night) + bkns.FoodPrice + bkns.TransPrice) * 0.9;
            ...
            else
            {
                ...
                bkns.Phone = Request["TxtPhone"].ToString();
                bkns.Total = (250 * bkns.Mem * bkns.Norooms1) + (10 * bkns.Night) + bkns.FoodPrice + bkns.TransPrice;
                bkns.Checkin1 = checkin.SelectedDate.ToShortDateString();
                bkns.Checkout1 = checkout.SelectedDate.ToShortDateString();
                BookingsBusinessClass.AddNewBooking(bkns);
            }
           ...
           "alert(' You have successfully made a booking ..!'); location.href='Rooms.aspx';",
           true);
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Session["Lang"].ToString() == "fr-FR")
            {
                ...
                Response.Redirect("~/Deluxe-Room.aspx");
            }
        ...
        protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Deluxe-Room.aspx?Theme=" + name);
