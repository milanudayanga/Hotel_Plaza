<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="WebApplication8.ForgotPassword" %>
		...
		<div class="container">
			<div class="register">
				 ...
				 <div class="register-top-grid">
					...
					<h3>
                        <asp:Label ID="Label7" runat="server" Text="PERSONAL INFORMATION"></asp:Label></h3>
                   ...
                   <div class="wow fadeInRight" data-wow-delay="0.4s">
                    ...
                    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true"  ForeColor="Black" BackColor="Gray">
				     ...
				     <div class="register-bottom-grid">
						    <h3>  <asp:Label ID="Label4" runat="server" Text="LOGIN INFORMATION"></asp:Label></h3>
							 <div class="wow fadeInLeft" data-wow-delay="0.4s">
                                 <asp:Label ID="Label6" runat="server" Text="Password"></asp:Label>
							 <asp:TextBox ID="TxtPassword" runat="server"></asp:TextBox>
             <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator1" controltovalidate="TxtPassword" errormessage="Please enter password!"  ForeColor="Red"/>

							 </div>
							 <div class="wow fadeInRight" data-wow-delay="0.4s">
                                 <asp:Label ID="Label5" runat="server" Text="Confirm Password"></asp:Label>
							 <asp:TextBox ID="TxtConfirmPassword" runat="server"></asp:TextBox>
         <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator3" controltovalidate="TxtConfirmPassword" errormessage="Please enter password!"  ForeColor="Red"/>
