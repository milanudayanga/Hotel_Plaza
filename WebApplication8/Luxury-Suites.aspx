<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Luxury-Suites.aspx.cs" Inherits="WebApplication8.Luxury_Suites" %>
	...
	<div class="details">
		<div class="container">
			...
			<div class="col-md-5 details-right">
                <span><strong> <asp:Label ID="Label20" runat="server" Font-Size="XX-Large" Font-Bold="true" ForeColor="Purple" Text="LUXURY SUITES"/></strong></span><br />
				<span><strong><asp:Label ID="Label21" runat="server" Font-Size="Medium" ForeColor="#848583" /></strong></span><ul>				                                                
				<li> <asp:Label ID="Label19" runat="server" Font-Size="Medium" ForeColor="#848583" Text="Number of rooms: 4"/></li>
				<li> <asp:Label ID="Label18" runat="server" Font-Size="Medium"  ForeColor="#848583" Text="Floors: All Three floors"/></li>
				<li> <asp:Label ID="Label17" runat="server" Font-Size="Medium"  ForeColor="#848583"  Text="Size: 850 square feet (79 square metres)"/></li> </ul>
				<p>  <asp:Label ID="Label16" runat="server" Font-Size="Medium"  ForeColor="#848583" Text="Our spacious Luxury Suites have separate living rooms with DVD player and home theatre system – perfect for a family night in or entertaining friends.
No waiting to use the bathroom, either, as it comes with twin basins, Jacuzzi and separate rainshower cubicle. Our well designed luxury suites provide you the best comforts and finest amenities any beach resort in Sri Lanka could offer."/></p>
			  </div>
		<div class="clearfix"> </div>
