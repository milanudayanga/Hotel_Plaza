...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LuxuryRoom.aspx.cs" Inherits="WebApplication8.LuxuryRoom" %>
	...
	<div class="details">
		<div class="container">
			...
			<div class="col-md-5 details-right">
                <span><strong> <asp:Label ID="Label20" runat="server" Font-Size="XX-Large" Font-Bold="true" ForeColor="Purple" Text="LUXURY ROOM"/></strong></span><br />
				<span><asp:Label ID="Label21" runat="server" Font-Size="Medium" ForeColor="Gray" Text="USD 188 per guest"/> </span><ul>				                                                
				<li> <asp:Label ID="Label19" runat="server" Font-Size="Medium" ForeColor="Gray" Text="Number of rooms: 15"/></li>
				<li> <asp:Label ID="Label18" runat="server" Font-Size="Medium"  ForeColor="Gray" Text="Floors: All Three floors"/></li>
				<li> <asp:Label ID="Label17" runat="server" Font-Size="Medium"  ForeColor="Gray" Text="Size: 480 square feet (44.6 square metres)"/></li> </ul>
				<p>  <asp:Label ID="Label16" runat="server" Font-Size="Medium" ForeColor="Gray" Text="Our luxury rooms have much larger balconies and seating areas. The bathroom contains a bathtub with overhead rain shower."/></p>
			  </div>
			<div class="clearfix"> </div>
