...
{
    public partial class LuxuryRoom : System.Web.UI.Page
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Session["mail"] != null)
            {
                ...
                bkns.Total = ((188 * bkns.Mem * bkns.Norooms1) + (10 * bkns.Night) + bkns.FoodPrice + bkns.TransPrice)*0.9;
            ...
            else
            {
                ...
                bkns.Phone = Request["TxtPhone"].ToString();
                bkns.Total = (188 * bkns.Mem * bkns.Norooms1) + (10 * bkns.Night) + bkns.FoodPrice + bkns.TransPrice;
                bkns.Checkin1 = checkin.SelectedDate.ToShortDateString();
                bkns.Checkout1 = checkout.SelectedDate.ToShortDateString();
                BookingsBusinessClass.AddNewBooking(bkns);
            }
        ...
        protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (Session["Lang"].ToString() == "fr-FR")
            {
                ...
                Response.Redirect("~/LuxuryRoom.aspx");
            }
        ...
        private void LoadString()
        {
            ...
            rm = new ResourceManager("WebApplication8.App_GlobalResources.LuxuryRoom", Assembly.GetExecutingAssembly());
        ...
        protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/LuxuryRoom.aspx?Theme=" + name);
