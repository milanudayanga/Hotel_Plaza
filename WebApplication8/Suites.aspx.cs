...
namespace WebApplication8
{
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        private void LoadString()
        {
            ...
            rm = new ResourceManager("WebApplication8.App_GlobalResources.Suites", Assembly.GetExecutingAssembly());
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (Session["mail"] != null)
            {
                ...
                bkns.Total = ((300 * bkns.Mem * bkns.Norooms1) + (10 * bkns.Night) + bkns.FoodPrice + bkns.TransPrice) * 0.9;
            ...
            else
            {
                ...
                bkns.Phone = Request["TxtPhone"].ToString();
                bkns.Total = (300 * bkns.Mem * bkns.Norooms1) + (10 * bkns.Night) + bkns.FoodPrice + bkns.TransPrice;
                bkns.Checkin1 = checkin.SelectedDate.ToShortDateString();
                bkns.Checkout1 = checkout.SelectedDate.ToShortDateString();
                BookingsBusinessClass.AddNewBooking(bkns);
            }
        ...
        protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/Suites.aspx?Theme=" + name);
