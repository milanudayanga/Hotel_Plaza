<%@ Page Title="" Language="C#" MasterPageFile="~/UserSite.Master" AutoEventWireup="true" CodeBehind="UserSentMessages.aspx.cs" Inherits="WebApplication8.UserSentMessages" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <td><asp:Label ID="Label1" runat="server" Text="Date :" ForeColor="Black" Font-Bold="true"></asp:Label>  <%# Eval("Date")%>
             ...
             <br />
               <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("Email","~/UserSentMsgDel.aspx?Email={0}") %>'>Delete</asp:HyperLink>  &nbsp;&nbsp;
